...
namespace Project.Application.Features.Services
{
    public class TicketService : ITicketService
    {
        ...
        public async Task<TicketMessageDTO> AddMessage(CreateTicketMessage input, bool byAdmin = true)
        {
            var findTicket = await _ticketRepository.GetNoTracking(input.TicketId);
            if (findTicket == null)
            {
            ...
            return _mapper.Map<TicketMessageDTO>(res);
        }
